...
### Принцип I. Продуктовая микросервисная архитектура
...
- Используются только opensource-решения для вычислений, хранения данных, очередей.
...
- Документация и спецификации ведутся на русском языке, включают примеры curl и скриптов, описание алгоритмов для бизнеса и руководства по запуску.
